...
O InnovvBooks é uma loja virtual que vende livros da Casa do Código. 
...
```
{
    ...
    "email": "luiz.claudio@innovvationet.com.br",
    "senha": "123456",
    "endereco": "Rua Quiririm, 644",
    "complemento": "Vila Valqueire",
    "cep": "21330-650"
}
```
